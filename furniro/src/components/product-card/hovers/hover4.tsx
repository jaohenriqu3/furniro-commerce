...
export function CardHover4({ productSlug }: CardHoverProps) {
  ...
  // };
    ...
    return (
      <div className="card-hover">
       ...
       <Link to='single-product4'> <button className="btn-details"> Add to cart </button> </Link>
