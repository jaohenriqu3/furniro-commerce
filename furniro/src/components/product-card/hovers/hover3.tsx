...
export function CardHover3({ productSlug }: CardHoverProps) {
  ...
  // };
    ...
    return (
      <div className="card-hover">
       ...
       <Link to='single-product3'> <button className="btn-details"> Add to cart </button> </Link>
