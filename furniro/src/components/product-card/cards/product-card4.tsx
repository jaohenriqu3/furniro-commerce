...
import CardHover4  from '../hovers/hover4'; 
...
const ProductCard4: React.FC = () => {
  ...
  return (
    ...
    >
      <img alt={product.name} src={respira} />
      ...
      {isHovered && <CardHover4 productSlug={product.id} />} {/* Renderiza o hover */}
